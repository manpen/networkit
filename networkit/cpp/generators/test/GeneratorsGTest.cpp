...
TEST_F(GeneratorsGTest, testDynamicHyperbolicGeneratorOnMovedNodes) {
	...
	Graph G = HyperbolicGenerator(angles, radii, Hyperbolic::Radius(R), Hyperbolic::Alpha(alpha), T).generate();
	...
	Graph comparison = HyperbolicGenerator(angles, radii, Hyperbolic::Radius(R), Hyperbolic::Alpha(alpha), T).generate();
