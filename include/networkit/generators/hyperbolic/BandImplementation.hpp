...
#ifndef HYPERBOLICGENERATOR_BAND_H_
#define HYPERBOLICGENERATOR_BAND_H_
...
class BandImplementation {
	friend class ::NetworKit::DynamicHyperbolicGenerator;
public:
	BandImplementation() = default;
	 ...
	 */
	Graph generate(const std::vector<double> &angles, const std::vector<double> &radii, double R);
...
private:
	...
	std::vector<Aux::Timer> threadtimers; //!< times
};

} // namespace HyperbolicGenerators
} // namespace NetworKit

#endif /* HYPERBOLICGENERATOR_BAND_H_ */
